...
class Background(pygame.sprite.Sprite):
    def __init__(self):
        ...
        kind = ("day", "night")
        image = config.ResourcesLoader.backgroundImg[random.sample(kind, 1)[0]]
...
class Base(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # 用的方法和背景一样，两倍宽，不断向左移
        image = config.ResourcesLoader.baseImg
...
class Bird(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imgTpl = list(config.ResourcesLoader.birdImg[random.sample(kind, 1)[0]])
...
class Pipe(pygame.sprite.Sprite):
    ...
    def genPair(base: pygame.sprite.Sprite) -> tuple:
        kind = ("green", "red")
        image = config.ResourcesLoader.pipeImg[random.sample(kind, 1)[0]]
...
class Score(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.numDict = config.ResourcesLoader.numImg
...
class Message(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = config.ResourcesLoader.messageImg
        self.rect = self.image.get_rect()
